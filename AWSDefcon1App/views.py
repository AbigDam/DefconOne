...
def makegame(request,game_id):
    ...
    Nations.objects.create(    game=game_obj,    name='United States',  user = user_usa,  player_number=2,    states=36,    divisions=70/hard,    boats=250/hard,    planes=3000/hard,    alliance_name='The Neutrality Pact',    points=1,    nuke_time=8,    nukes=0, attacks = 5, requests = 10)#Player 3
    ...
    Nations.objects.create(    game=game_obj,    name='Japan',  user = user_japan,  player_number=7,    states=24,    divisions=340/hard,    boats=300/hard,    planes=6500/hard,    alliance_name='Axis',    points=1,    nuke_time=8,    nukes=0, attacks = 5, requests = 10)#Player 8
    ...
    Nations.objects.create( game=game_obj, name = 'China', player_number = 19, states = 22, divisions = 18, boats = 50, planes = 5000, alliance_name='', points = 0, nuke_time = 8, nukes = 0, attacks = 2, requests = 4 )
    ...
    Nations.objects.create( game=game_obj, name = 'Philippines', player_number = 42, states = 7, divisions = 33, boats = 50, planes = 5000, alliance_name='The Neutrality Pact', points = 0, nuke_time = 8, nukes = 0, attacks = 2, requests = 4 )
    ...
    Nations.objects.create( game=game_obj, name = 'Guangxi Clique', player_number = 44, states = 5, divisions = 35, boats = 50, planes = 5000, alliance_name='', points = 0, nuke_time = 8, nukes = 0, attacks = 2, requests = 4 )
    ...
    Nations.objects.create( game=game_obj, name = 'Mongolia', player_number = 47, states = 5, divisions = 35, boats = 50, planes = 5000, alliance_name='', points = 0, nuke_time = 8, nukes = 0, attacks = 2, requests = 4 )
    Nations.objects.create( game=game_obj, name = 'Xibei San Ma', player_number = 48, states = 7, divisions = 33, boats = 50, planes = 5000, alliance_name='', points = 0, nuke_time = 8, nukes = 0, attacks = 2, requests = 4 )
    ...
    Nations.objects.create( game=game_obj, name = 'Yunnan', player_number = 56, states = 2, divisions = 38, boats = 50, planes = 5000, alliance_name='', points = 0, nuke_time = 8, nukes = 0, attacks = 2, requests = 4 )
    ...
    Nations.objects.create( game=game_obj, name = 'Sinkiang', player_number = 59, states = 6, divisions = 34, boats = 50, planes = 5000, alliance_name='', points = 0, nuke_time = 8, nukes = 0, attacks = 2, requests = 4 )
    ...
    Nations.objects.create( game=game_obj, name = 'Manchukuo', player_number = 68, states = 7, divisions = 33, boats = 50, planes = 5000, alliance_name='Axis', points = 0, nuke_time = 8, nukes = 0, attacks = 2, requests = 4 )
    ...
    Nations.objects.create( game=game_obj, name = 'Mengkukuo', player_number = 75, states = 2, divisions = 38, boats = 50, planes = 5000, alliance_name='Axis', points = 0, nuke_time = 8, nukes = 0, attacks = 2, requests = 4 )
    Nations.objects.create( game=game_obj, name = 'Shanxi', player_number = 76, states = 3, divisions = 37, boats = 50, planes = 5000, alliance_name='', points = 0, nuke_time = 8, nukes = 0, attacks = 2, requests = 4 )
    Nations.objects.create( game=game_obj, name = 'Communist China', player_number = 77, states = 1, divisions = 39, boats = 50, planes = 5000, alliance_name='', points = 0, nuke_time = 8, nukes = 0, attacks = 2, requests = 4 )
    ...
    Nations.objects.create( game=game_obj, name = 'Tannu Tuva', player_number = 88, states = 1, divisions = 39, boats = 50, planes = 5000, alliance_name='', points = 0, nuke_time = 8, nukes = 0, attacks = 2, requests = 4 )
